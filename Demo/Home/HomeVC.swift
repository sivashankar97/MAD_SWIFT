...
struct HomeVC: View {
    ...
    let arrProduct = [
        ...
        Product(
            name: "the main body of a book or other piece of writing, as distinct from other material such as notes, appendices, and illustrations.", imageName: "pink-birds"),
